...
buf.push("<div class=\"navbar-brand title\"><img src=\"./img/icon_white.svg\" class=\"logo\"/>strokey</div><ul class=\"navbar-nav mr-auto\"><li class=\"nav-item\"><a style=\"cursor:pointer\" onClick=\"Radio.channel('usb').request('devices');\" class=\"nav-link\"><i class=\"fa fa-fw fa-lg fa-usb\"></i></a></li></ul>");;return buf.join("");
};
...
},{"./app":1,"./application/views/layout":2,"./components/about/component":8,"./components/header/component":11,"./config":15,"./modules/key/factory":21,"./modules/main/router":61,"./modules/usb/chrome_web_usb_service":62,"hn_entities/lib/config":70,"hn_flash/lib/component":73,"hn_overlay/lib/component":81}],20:[function(require,module,exports){
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<li" + (jade.attr("data-keycode", opts.keycode, true, false)) + " data-click=\"key\"" + (jade.attr("data-key", opts.key, true, false)) + (jade.attr("title", opts.title, true, false)) + (jade.cls(['btn','btn-outline-light','keyboard--key',opts.css], [null,null,null,true])) + ">");
if ( opts.icon)
{
...
{
buf.push("<div class=\"plain\">" + (jade.escape(null == (jade_interp = opts.label || opts.shift_key) ? "" : jade_interp)) + "</div>");
}
else
{
buf.push("<div class=\"plain\">" + (jade.escape(null == (jade_interp = opts.label || opts.key) ? "" : jade_interp)) + "</div>");
}
}
buf.push("</li>");
};
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (r0, r1, r2, r3) {
jade_mixins["keyboardRow"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<ul class=\"list-unstyled mb-0 keyboard--row w-100\">");
block && block();
...
buf.push("</div></div></div>");}.call(this,"r0" in locals_for_with?locals_for_with.r0:typeof r0!=="undefined"?r0:undefined,"r1" in locals_for_with?locals_for_with.r1:typeof r1!=="undefined"?r1:undefined,"r2" in locals_for_with?locals_for_with.r2:typeof r2!=="undefined"?r2:undefined,"r3" in locals_for_with?locals_for_with.r3:typeof r3!=="undefined"?r3:undefined));;return buf.join("");
};
...
},{"jade/runtime":84}],28:[function(require,module,exports){
...
},{"./views/layout":39,"hn_routing/lib/route":82}],35:[function(require,module,exports){
...
DeviceLayout = (function(superClass) {
  ...
  DeviceLayout.prototype.className = 'row h-100';
...
},{"./keySelector":38,"./templates/device_layout":42,"./templates/device_status":43}],36:[function(require,module,exports){
...
},{"./templates/editor_selector":44,"lib/views/simple_nav":93}],37:[function(require,module,exports){
...
},{"./macroEditor":40,"./templates/editor_wrapper":45,"./textEditor":54}],38:[function(require,module,exports){
...
KeyChild = (function(superClass) {
  ...
  KeyChild.prototype.className = 'btn btn-outline-light key--child d-flex justify-content-center align-items-center mx-2 my-2';
...
KeySelector = (function(superClass) {
  ...
  KeySelector.prototype.className = 'key--list--wrapper px-3 py-3 d-flex align-items-center';
...
},{"./templates/key_child":47,"./templates/key_selector":48}],39:[function(require,module,exports){
...
HelpView = (function(superClass) {
  ...
  HelpView.prototype.className = 'row h-100 align-items-center';
...
LayoutView = (function(superClass) {
  ...
  LayoutView.prototype.className = 'container-fluid d-flex flex-column w-100 h-100 device--layout';
  ...
  LayoutView.prototype.showEditorView = function(keyModel, editor) {
    ...
    editorWrapper.on('cancel', (function(_this) {
      return function() {
        return _this.selectorRegion.show(new HelpView());
      };
    })(this));
    ...
    return this.selectorRegion.show(editorWrapper);
  };
...
},{"./deviceLayout":35,"./editorSelector":36,"./editorWrapper":37,"./templates/help_view":46,"./templates/layout":49}],40:[function(require,module,exports){
...
},{"./macroList":41,"./templates/macro_editor":51,"lib/views/keyboard_selector":91}],41:[function(require,module,exports){
...
MacroChild = (function(superClass) {
  ...
  MacroChild.prototype.templateHelpers = function() {
    ...
    } else if (this.model.get('key_up')) {
      active_position = {
        position: 255,
        css: 'fa-arrow-up',
        tooltip: 'Wait for key release'
      };
      return {
        active_position: active_position
      };
...
},{"./templates/macro_child":50,"./templates/macro_empty":52}],42:[function(require,module,exports){
var jade = require("jade/runtime");
...
buf.push("<div class=\"col-lg-12 d-flex justify-content-center align-items-center\"><div class=\"btn-group\">");
if ( connected)
{
buf.push("<button data-click=\"disconnect\" class=\"btn btn-sm btn-outline-secondary\"><i class=\"fa fa-fw fa-times mr-1\"></i>DISCONNECT</button>");
}
else
{
buf.push("<button data-click=\"connect\" class=\"btn btn-sm btn-outline-secondary\"><i class=\"fa fa-fw fa-usb mr-1\"></i>CONNECT</button>");
}
buf.push("</div></div><div data-region=\"keys\" class=\"key-selector-wrapper col-lg-12 d-flex justify-content-center align-items-center\"></div>");}.call(this,"connected" in locals_for_with?locals_for_with.connected:typeof connected!=="undefined"?connected:undefined));;return buf.join("");
};
},{"jade/runtime":84}],43:[function(require,module,exports){
var jade = require("jade/runtime");
...
if ( macro_editor)
{
buf.push("<button data-click=\"clear\" class=\"btn btn-sm btn-outline-warning mx-2 px-4\"><i class=\"fa fa-fw fa-2x mx-4 fa-times\"></i></button><button data-click=\"record\" class=\"btn btn-sm btn-outline-danger mx-2 px-4\"><i class=\"fa fa-fw fa-2x mx-4 fa-circle\"></i></button>");
}
...
buf.push("<div class=\"col-lg-12\"><div class=\"row my-4\"><div class=\"col-lg-12 text-center\"><img src=\"./img/icon_white.svg\" class=\"welcome-logo\"/></div></div><div class=\"row my-4\"><div class=\"col-lg-12 text-center\"><p class=\"welcome-text\">WELCOME</p></div></div><div class=\"row my-4\"><div class=\"col-lg-12 text-center\"><p class=\"lead\"><a href=\"https://github.com/AstroKey\" target=\"_blank\"> AstroKey</a> is an open-source platform for automating keyboard workflows.</p>\n</div></div><div class=\"row py-2\"><div class=\"col-lg-12 text-center\"><p class=\"lead\">Drag and drop keyboard keys to construct your desired workflow - AstroKey does the rest.</p></div></div><div class=\"row py-4\"><div class=\"col-lg-12 d-flex flex-row align-items-center justify-content-center\"><p style=\"letter-spacing: 0.25rem; font-weight: 200;\" class=\"d-flex lead m-0\">Click a key to get started</p></div></div><div class=\"row\"><div class=\"col-lg-12 text-center\"><hr/><p>Built with<i class=\"fa fa-heart-o ml-1\"></i>&nbsp;by&nbsp;<a href=\"https://github.com/AaronPerl\" target=\"_blank\">Aaron Perl</a>&nbsp;and&nbsp;<a href=\"http://aeks.co\" target=\"_blank\">Alexander Schwartzberg</a>&nbsp;@&nbsp;<a href=\"https://rcos.io/\" target=\"_blank\">RCOS.</a></p></div></div></div>");;return buf.join("");
};
...
buf.push("<img src=\"./img/icon_white.svg\" class=\"logo\"/><ul class=\"list-unstyled key--list d-flex\"></ul><img src=\"./img/icon_white.svg\" class=\"logo side\"/>");;return buf.join("");
};
...
buf.push("<div class=\"row device--overlay\"><div data-region=\"device\" class=\"col-sm-12 col-md-6 col-lg-3 device-region\"></div><div data-region=\"selector\" class=\"col-sm-12 col-md-6 col-lg-9\"></div></div>");;return buf.join("");
};
...
},{"../key/keys":22,"../macro/entities":28}],57:[function(require,module,exports){
...
},{"./dashboard/route":34,"./factory":57,"./home/route":58,"hn_routing/lib/router":83}],62:[function(require,module,exports){
...
NavKeyboard = (function(superClass) {
  ...
  NavKeyboard.prototype.template = require('./templates/keyboard_nav');
...
},{"./templates/keyboard_nav":25,"lib/views/keyboard_abstract":85}],90:[function(require,module,exports){
...
},{"./templates/keyboard_numpad":26,"lib/views/keyboard_abstract":85}],91:[function(require,module,exports){
...
},{"./templates/keyboard_selector":27,"lib/views/keyboard_full":86,"lib/views/keyboard_function":87,"lib/views/keyboard_media":88,"lib/views/keyboard_nav":89,"lib/views/keyboard_numpad":90,"lib/views/keyboard_special":92,"lib/views/simple_nav":93}],92:[function(require,module,exports){
...
},{"lib/views/keyboard_abstract":85}],93:[function(require,module,exports){
var SimpleNav,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
